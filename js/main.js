...
function Search(a) {
    ...
    this.search = function (a) {
        ...
        this.lastSearch = a;
        this.results.empty();
        if (2 >= a.length) this.results.html("<i>Ingresá 3 letras como mínimo para buscar.</i>");
        else {
            ...
            0 == c.length && !b && a.push("<i>No hay resultados</i>");
...
function nodeActive(a) {
	...
	//console.log(sigInst.neighbors);
	 ...
	 {
        size=Object.size(sigInst.neighbors);f.push("<h2>(Total " + size + ")</h2>");
